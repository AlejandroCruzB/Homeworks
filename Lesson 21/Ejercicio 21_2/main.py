...
class MensajesHandler(BaseHandler):
    def get(self):
        messages = Message.query().fetch()
        params = {"messages": messages}
        return self.render_template("mensajes.html", params=params)
...
app = webapp2.WSGIApplication([
    ...
    webapp2.Route('/mensajes', MensajesHandler, name="m"),
